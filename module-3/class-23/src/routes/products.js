...
productRouter.post('/add-product', AuthMiddleware , async (req, res)=>{
    try {
...
productRouter.post('/add-multiple-products', AuthMiddleware, async (req, res)=>{
    try {
...
productRouter.delete('/delete-product/:id', AuthMiddleware, async (req, res)=>{
...
productRouter.put('/update-product/:id', AuthMiddleware, async (req, res)=>{
    try {
        const { id } = req.params;
